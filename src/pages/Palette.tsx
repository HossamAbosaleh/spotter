...
const CANDIDATES: Candidate[] = [
  {
    letter: 'A',
    name: 'Strain Blue + Signal Red — Whoop-grade data identity',
    primary: '#0093e7',
    primaryForeground: '#f0f0f0',
    secondary: '#ef4444',
    contrast: '4.7:1 (strain-blue/light)',
  },
  {
    letter: 'B',
    name: 'Lift Red + Bone — Hevy-grade strength floor',
    primary: '#dc2626',
    primaryForeground: '#f0f0f0',
    secondary: '#e7e5e4',
    contrast: '5.9:1 (red/light)',
  },
  {
    letter: 'C',
    name: 'Scoreboard Yellow + Strain Blue — jumbotron / broadcast graphic',
    primary: '#fde047',
    primaryForeground: '#0d0d0f',
    secondary: '#0093e7',
    contrast: '16.4:1 (yellow/dark)',
  },
];
